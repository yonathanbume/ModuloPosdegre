...
namespace AKDEMIC.REPOSITORY.Repositories.Generals.Interfaces
{
    public interface ITeacherRepository : IRepository<Teacher>
    {
        ...
        Task<IEnumerable<Teacher>> GetPerformanceByCareerAndTermAndWeekAndDedication(Guid termId, int week,
            Guid? facultyId = null, Guid? teacherDedicationId = null);
        ...
        Task<IEnumerable<TeacherTemplateA>> GetTeachersModelA(Guid? facultyId, string coordinatorId = null, Guid? academicDepartmentId = null, ClaimsPrincipal user=null);
        ...
        Task<DataTablesStructs.ReturnedData<object>> GetTeachersDatatable(DataTablesStructs.SentParameters sentParameters, Guid? facultyId, Guid? careerId, string search = null, Guid? termId = null, Guid? academicDepartmentId = null, ClaimsPrincipal user = null);
