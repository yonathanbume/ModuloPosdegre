...
{
    public interface IUserInternalProcedureRepository : IRepository<UserInternalProcedure>
    {
        ...
        Task<IEnumerable<UserInternalProcedure>> GetDispatchedUserInternalProceduresDatatableByInternalProcedureUser(DataTablesStructs.SentParameters sentParameters, string internalProcedureUserId, string userIdd);
        ...
        Task<IEnumerable<UserInternalProcedure>> GetParentUserInternalProceduresByInternalProcedure(Guid internalProcedureId, Guid? internalProcedureDependencyId);
        Task<IEnumerable<UserInternalProcedure>> GetParentUserInternalProceduresByInternalProcedure(Guid internalProcedureId, Guid? internalProcedureDependencyId, DateTime? startCreatedAt, DateTime? endCreatedAt);
       // Task<DataTablesStructs.ReturnedData<object>> GetParentUserInternalProceduresByInternalProcedureDatatble(DataTablesStructs.SentParameters sentParameters, Guid internalProcedureId, Guid? dependencyId, DateTime? startCreatedAt, DateTime? endCreatedAt);
        ...
        Task<IEnumerable<UserInternalProcedure>> GetParentUserInternalProceduresDatatableByInternalProcedure(DataTablesStructs.SentParameters sentParameters, Guid internalProcedureId, Guid internalProcedureDependencyId);
        Task<IEnumerable<UserInternalProcedure>> GetParentUserInternalProceduresDatatableByInternalProcedure(DataTablesStructs.SentParameters sentParameters, Guid internalProcedureId, Guid internalProcedureDependencyId, DateTime? startCreatedAt, DateTime? endCreatedAt);
        ...
        Task<IEnumerable<UserInternalProcedure>> GetRecievedUserInternalProceduresByUserDependencyUser(string userDependencyUserId, Guid dependencyId, string search = null, int? status = null);
