...
namespace AKDEMIC.REPOSITORY.Repositories.ComputerManagement.Implementations
{
    ...
    {
        public HardwareTypeRepository(AkdemicContext context):base(context) { }
        ...
        {
            Expression<Func<HardwareType, dynamic>> orderByPredicate = null;
            ...
            var query = _context.HardwareTypes.AsNoTracking();
