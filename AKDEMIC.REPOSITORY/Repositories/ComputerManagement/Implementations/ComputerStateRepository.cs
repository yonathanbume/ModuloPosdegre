...
{
    public class ComputerStateRepository : Repository<ComputerState> , IComputerStateRepository
    {
        public ComputerStateRepository(AkdemicContext context) : base(context) { }
        ...
        {
            Expression<Func<ComputerState, dynamic>> orderByPredicate = null;
            ...
            var query = _context.ComputerState.AsNoTracking();
