...
{
    public interface IPerformanceEvaluationUserRepository
    {
        ...
        Task<PerformanceEvaluationUserDetail> GetResult(Guid templateId, string toUserId, string fromRoleId, Guid? sectionId = null);
