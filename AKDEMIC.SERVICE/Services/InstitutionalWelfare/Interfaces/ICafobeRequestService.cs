...
{
    public interface ICafobeRequestService
    {
        Task<CafobeRequest> Get(Guid id);
        ...
        Task<IEnumerable<CafobeRequest>> GetAll();
        Task Insert(CafobeRequest cafobeRequest);
        Task Update(CafobeRequest cafobeRequest);
        Task Delete(CafobeRequest cafobeRequest);
