...
{
    public interface IRegistryPatternService
    {
        Task<IEnumerable<RegistryPattern>> GetAll();
        Task<RegistryPattern> Get(Guid id);
        ...
        Task<RegistryPattern> Add(RegistryPattern model);
        Task Insert(RegistryPattern model);
        Task Update(RegistryPattern model);
        ...
        Task<DataTablesStructs.ReturnedData<object>> GetRelationDegreeDatatable(DataTablesStructs.SentParameters sentParameters, DateTime startDateTime, DateTime endDateTime, string bookCode, string searchValue = null);
        Task<DataTablesStructs.ReturnedData<object>> GetRegistryPatternApprovedDatatableByConfiguration(DataTablesStructs.SentParameters sentParameters, Guid? careerId, string searchBookNumber = null, string dateStartFilter = null, string dateEndFilter = null, string searchValue = null, int? status = null);
