...
{
    public interface IUserProcedureService
    {
        ...
        Task<UserProcedure> Get(Guid id);
        ...
        Task AddAsync(UserProcedure userProcedure);
        Task Delete(UserProcedure userProcedure);
        Task Insert(UserProcedure userProcedure);
        Task Update(UserProcedure userProcedure);
        ...
        Task<DataTablesStructs.ReturnedData<object>> GetExtemporaneousEnrollmentDatatableServerSide(DataTablesStructs.SentParameters sentParameters, ClaimsPrincipal user = null);
