...
{
    public interface IJobOfferApplicationService
    {
        ...
        Task Update(JobOfferApplication jobOfferApplication);
        Task Insert(JobOfferApplication jobOfferApplication);
        Task Delete(JobOfferApplication jobOfferApplication);
