...
namespace AKDEMIC.SERVICE.Services.JobExchange.Interfaces
{
    public interface IStudentExperienceService
    {
        ...
        Task Insert(StudentExperience studentExperience);
        Task Remove(StudentExperience studentExperience);
        ...
        Task Update(StudentExperience studentExperience);
        Task<object> GetStudentExperiencePersonalized(Guid studentexperienceId);
