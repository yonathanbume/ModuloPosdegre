...
namespace AKDEMIC.SERVICE.Services.TeachingManagement.Interfaces
{
    public interface ITeacherScheduleService
    {
        ...
        Task Insert(TeacherSchedule teacherSchedule);
        Task Delete(TeacherSchedule teacherSchedule);
        Task Update(TeacherSchedule teacherSchedule);
        Task DeleteById(Guid teacherScheduleId);
        ...
        Task InsertRange(IEnumerable<TeacherSchedule> teacherSchedules);
        Task DeleteRange(IEnumerable<TeacherSchedule> teacherSchedules);
        Task UpdateRange(IEnumerable<TeacherSchedule> teacherSchedules);
