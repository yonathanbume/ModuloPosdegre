...
namespace AKDEMIC.SERVICE.Services.Generals.Interfaces
{
    ...
    {
        Task<Select2Structs.ResponseParameters> GetAcademicProgramsSelect2(Select2Structs.RequestParameters requestParameters, Guid? idSelected, string v);
        Task<AcademicProgram> Get(Guid id);
        Task<IEnumerable<AcademicProgram>> GetAll();
        ...
        Task InsertAsync(AcademicProgram academicProgram);
        Task UpdateAsync(AcademicProgram academicProgram);
        Task DeleteAsync(AcademicProgram academicProgram);
