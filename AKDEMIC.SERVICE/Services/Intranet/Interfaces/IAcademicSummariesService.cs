...
{
    public interface IAcademicSummariesService
    {
        ...
        Task<IEnumerable<AcademicSummaryReportTemplate>> GetAcademicSummariesReportAsData(Guid? careerId, Guid termId);
        ...
        Task<AcademicSummary> GetLastTermSanctionedByStudentId(Guid studnetId);
