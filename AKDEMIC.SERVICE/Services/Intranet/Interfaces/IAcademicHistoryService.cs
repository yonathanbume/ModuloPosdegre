...
namespace AKDEMIC.SERVICE.Services.Intranet.Interfaces
{
    public interface IAcademicHistoryService
    {
        ...
        Task<IEnumerable<AcademicHistory>> GetAll();
        void RemoveRange(IEnumerable<AcademicHistory> academicHistories);
        Task<AcademicHistory> Get(Guid id);
        Task<AcademicHistory> GetLastByStudentAndCourse(Guid studentId, Guid courseId);
        Task InsertRange(IEnumerable<AcademicHistory> academicHistories);
        ...
        Task<DataTablesStructs.ReturnedData<AcademicHistoryTemplate>> GetAcademicHistoryDatatable(DataTablesStructs.SentParameters parameters,Guid careerId,Guid curriculumId, Guid cid, Guid pid, string name);
        ...
        Task Insert(AcademicHistory academicHistory);
        ...
        Task AddRange(List<AcademicHistory> newAcademicHistories);
        ...
        Task StudentsCurriculumConvalidationJob(Guid studentId, Guid prevCurriculumId);
        Task Update(AcademicHistory academichistory);
        Task<AcademicHistory> GetByStudentIdAndCourseId(Guid studentId, Guid courseId);
        Task Delete(AcademicHistory academichistory);
