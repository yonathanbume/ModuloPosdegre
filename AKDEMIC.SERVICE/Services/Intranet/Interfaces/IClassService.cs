...
namespace AKDEMIC.SERVICE.Services.Intranet.Interfaces
{
    public interface IClassService
    {
        ...
        Task InsertAync(Class _class);
        Task InsertRangeAync(IEnumerable<Class> _clases);
        Task UpdateAync(Class _class);
        Task DeleteAync(Class _class);
        Task DeleteRange(IEnumerable<Class> entites);
