...
namespace AKDEMIC.SERVICE.Services.InterestGroup.Interfaces
{
    public interface IInterestGroupService
    {
        ...
        Task Insert(ENTITIES.Models.InterestGroup.InterestGroup entity);
        Task Update(ENTITIES.Models.InterestGroup.InterestGroup entity);
        Task Delete(ENTITIES.Models.InterestGroup.InterestGroup entity);
        Task<ENTITIES.Models.InterestGroup.InterestGroup> Get(Guid id);
        ...
        Task<Select2Structs.ResponseParameters> GetActiveInterestGroupsByForumsSelect2(Select2Structs.RequestParameters requestParameters, string userId, Guid? id, string search);
