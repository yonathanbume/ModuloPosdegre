...
namespace AKDEMIC.SERVICE.Services.Investigation.Implementations
{
    public class ProjectActivityService : IProjectActivityService
    {
        ...
        public async Task<IEnumerable<ProjectActivity>> GetAll()
        {
            return await _projectActivityRepository.GetAll();
        }
        ...
        {
            return await _projectActivityRepository.GetBudgetSumByProjectId(projectId,ignoredId);
        }
    }
}
