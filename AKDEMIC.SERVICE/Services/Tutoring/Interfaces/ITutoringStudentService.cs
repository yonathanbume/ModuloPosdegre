...
{
    public interface ITutoringStudentService
    {
        Task<TutoringStudent> GetByUserId(string userId);
        Task<TutoringStudent> GetByStudentId(Guid studentId);
        Task<TutoringStudent> Get(Guid tutoringStudentId);
        Task<TutoringStudent> GetWithData(Guid tutoringStudentId, Guid termId);
        Task<bool> Any(Guid tutoringStudentId);
        Task<bool> AnyByTermId(Guid tutoringStudentId, Guid termId);
        Task DeleteById(Guid tutoringStudentId);
        Task Delete(TutoringStudent tutoringStudent);
        Task Update(TutoringStudent tutoringStudent);
        Task Insert(TutoringStudent tutoringStudent);
        Task<IEnumerable<TutoringStudent>> GetAll();
        ...
        Task<int> CountByCareerIdAndTutorId(Guid? careerId = null, string tutorId = null, Guid? ternId = null);
