...
namespace AKDEMIC.SERVICE.Services.Tutoring.Interfaces
{
    ...
    {
        Task<IEnumerable<TutoringSession>> GetAll();
        ...
        Task<TutoringSession> Get(Guid tutoringSessionId);
        Task<TutoringSession> Get(Guid id, string tutorId = null, bool? isMultiple = null);
        Task Insert(TutoringSession tutoringSession);
        Task Update(TutoringSession tutoringSession);
        Task DeleteById(Guid tutoringSessionId);
        Task Delete(TutoringSession tutoringSession);
