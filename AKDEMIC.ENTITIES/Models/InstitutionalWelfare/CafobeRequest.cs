...
{
    public class CafobeRequest:Entity, ITimestamp
    {
        ...
        public int Type { get; set; } // AKDEMIC.CORE.Helpers.ConstantHelpers.CAFOBE_REQUEST.TYPE;
        public int Status { get; set; } // AKDEMIC.CORE.Helpers.ConstantHelpers.CAFOBE_REQUEST.STATUS;
        ...
        public decimal SupportAmount { get; set; } //Cantidad de apoyo economico asignado
