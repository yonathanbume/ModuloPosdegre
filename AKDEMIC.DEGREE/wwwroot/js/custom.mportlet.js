...
var mPortlet = function (elementId, options) {
	...
	var defaultOptions = {
		...
		tools: {
			toggle: {
				collapse: mPortletDefaultOptions.tools.toggle.collapse,
				expand: mPortletDefaultOptions.tools.toggle.expand
			},
			reload: mPortletDefaultOptions.tools.reload,
			remove: mPortletDefaultOptions.tools.remove,
			fullscreen: {
				on: mPortletDefaultOptions.tools.fullscreen.on,
				off: mPortletDefaultOptions.tools.fullscreen.off
			}
		},
		sticky: {
			offset: 300,
