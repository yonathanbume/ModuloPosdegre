var InitApp = function () {
        ...
        init: function () {
            ...
            $(".btn-find").on("click", function () {
                if ($("#facultyId").val() == null || $("#facultyId").val() == "") {
                    ...
                    $.ajax({
                        url: (`/director-carrera/reporte-alumnos-competencias/nivel-de-logro-datos/${termId}/${facultyId}/${careerId}/${curriculumId}/${academicYear}`).proto().parseURL(),
                        type: "GET",
                        dataType: "html",
                        ...
                        $(".competence-details").on('click', function () {
                            ...
                            $.ajax({
                                type: "GET",
                                url: `/director-carrera/reporte-alumnos-competencias/obtener-datos-por-cantidad/${termId}/${facultyId}/${careerId}/${curriculumId}/${competenceId}/${avg}/${academicYear}`.proto().parseURL(),
                                beforeSend: function () {
                                ...
                                if (data != null) {
                                    if (data.rowChilds.length > 0) {
                                        ...
                                        datatable.on('click', '.view-courses', function (e) {
                                            ...
                                            $.ajax({
                                                type: "GET",
                                                url: `/director-carrera/reporte-alumnos-competencias/obtener-datos-por-cantidad-por-estudiante/${termId}/${facultyId}/${careerId}/${curriculumId}/${competenceId}/${type}/${academicYear}/${studentId}`.proto().parseURL(),
                                                beforeSend: function () {
                        ...
                        $("#btn-pdf").on('click', function () {
                            var button = $(this);
                            button.addLoader();
                            $.fileDownload(`/director-carrera/reporte-alumnos-competencias/descargar/pdf/${termId}/${facultyId}/${careerId}/${curriculumId}/${academicYear}`.proto().parseURL())
                                .done(function () {
                                    button.removeLoader();
                        ...
                        $("#btn-excel").on('click', function () {
                            var button = $(this);
                            button.addLoader();
                            $.fileDownload(`/director-carrera/reporte-alumnos-competencias/reporte-excel/${termId}/${facultyId}/${careerId}/${curriculumId}/${academicYear}`.proto().parseURL())
                                .done(function () {
                                    button.removeLoader();
                                    toastr.success("Archivo descargado satisfactoriamente", "Éxito");
                                })
    ...
    var loadChart = function () {
        $.ajax({
            url: ("/director-carrera/reporte-alumnos-competencias/get").proto().parseURL(),
            data: {
                termId: $("#termId").val(),
