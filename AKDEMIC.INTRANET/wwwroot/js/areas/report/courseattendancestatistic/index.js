    ...
    var datatable = {
        courses: {
            ...
            options: {
                ...
                ajax: {
                    url: "/reporte/asistencia-curso/get".proto().parseURL(),
                    type: "GET",
                    dataType: "JSON",
                    data: function (data) {
                        delete data.columns;
                ...
                buttons: [
                    {
                        ...
                        action: function (e, dt, node, config) {
                            var url = `/reporte/asistencia-curso/get-excel?termId=${$("#term_select").val()}&careerId=${$("#career_select").val()}&curriculumId=${$("#curriculum_select").val()}`;
