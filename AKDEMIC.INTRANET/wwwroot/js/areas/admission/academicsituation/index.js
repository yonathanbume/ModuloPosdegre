var AcademicSituation = function () {
    ...
    var options = {
        ...
        serverSide: true,
        ajax: {
            url: "/admision/situacion-academica/get".proto().parseURL(),
            data: function (d) {
    ...
    var datatable = {
        ...
        initEvents: function () {
            studentDatatable.on("click",
                ...
                function () {
                    var id = $(this).data("id");
                    location.href = `/admision/situacion-academica/${id}/situacion`.proto().parseURL();
                });
            ...
            studentDatatable.on("click",
                ...
                function () {
                    var id = $(this).data("id");
                    location.href = `/admision/situacion-academica/${id}/historial`.proto().parseURL();
                });
        }
    };
