var index = function () {
    ...
    var datatable = {
        sections: {
            ...
            options: {
                ajax: {
                    url: `/profesor/examen-subsanacion/get-datatable`,
                    type: "GET",
                    data: function (data) {
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        title: "Opciones",
                        data: function (row) {
                            var tpm = `<a href="/profesor/examen-subsanacion/${row.id}/estudiantes" class="btn btn-primary btn-sm m-btn  m-btn m-btn--icon"><span><i class="la la-edit"></i><span>Calificar</span></span></a>`;
                            return tpm;
                        }
                    }
                ]
