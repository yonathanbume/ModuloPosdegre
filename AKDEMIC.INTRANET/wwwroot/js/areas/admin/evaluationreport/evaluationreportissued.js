                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        render: function (data) {
                            ...
                            var detailUrl = `/admin/generacion-actas/acta/${data.id}/detalle`.proto().parseURL();
                            var template = "";
                            //Ver
                            template += "<button ";
                            template += "class='btn btn-brand ";
                            template += "m-btn btn-sm m-btn--icon btn-detail' ";
                            template += ` data-url=${detailUrl}>`;
                            template += "<span><i class='la la-eye'></i><span>Ver Detalle</span></span></button> ";
                            //Descargar
                            template += "<button ";
