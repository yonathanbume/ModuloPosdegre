var index = function () {
    ...
    var datatable = {
        deferredExam : {
            ...
            options: {
                ajax: {
                    url: `/admin/generacion-actas/get-examenes-aplazados-datatable`,
                    type: "GET",
                    data: function (data) {
            ...
            reload: function () {
                datatable.deferredExam.object.ajax.reload();    
            },
            events: {
                onPreview: function () {
                    $("#data-table").on("click", ".btn-preview-details", function () {
                        ...
                        $.ajax({
                            url: `/admin/generacion-actas/examen-aplazado/vista-previa?deferredExamId=${id}`.proto().parseURL(),
                            type: "GET",
                            dataType: "html",
                ...
                onReport: function () {
                    $("#data-table").on("click", ".btn-generate", function () {
                            ...
                            var $btn = $(this);
                            $btn.addLoader();
                            $.fileDownload(`/admin/generacion-actas/examanes-aplazados/imprimir-acta?id=${id}`, {
                                httpMethod: 'GET', successCallback: function () {
                                    $btn.removeLoader();
                                    toastr.success("Archivo descargado satisfactoriamente", "Éxito");
                                    datatable.deferredExam.reload();
                                },
            ...
            init: function () {
                datatable.deferredExam.object = $("#data-table").DataTable(datatable.deferredExam.options);
                datatable.deferredExam.events.init();
            }
        },
        init: function () {
            datatable.deferredExam.init();
        }
    }
