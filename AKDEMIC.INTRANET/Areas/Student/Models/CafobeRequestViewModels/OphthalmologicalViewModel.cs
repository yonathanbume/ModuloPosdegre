...
{
    public class OphthalmologicalViewModel
    {
        ...
        public IFormFile OpthicalMedicalDiagnosticFile { get; set; }
        public string OpthicalMedicalDiagnosticUrl { get; set; }

        public IFormFile OpthicalProformFile { get; set; }
        public string OpthicalProformUrl { get; set; }
