...
namespace AKDEMIC.INTRANET.Areas.Student.Models.CafobeRequestViewModels
{
    public class HighPerformanceViewModel
    {
        ...
        public IFormFile ApprovedResolutionFile { get; set; }
        public string ApprovedResolutionUrl { get; set; }
        ...
        public IFormFile ConstancyHigherFifthFile { get; set; }
        public string ConstancyHigherFifthUrl { get; set; }

        public IFormFile MeritChartHigherFifthFile { get; set; }
        public string MeritChartHigherFifthUrl { get; set; }
